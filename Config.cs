namespace MTFO
{
    internal static class Config
    {
        ...
        // --- Tuning Constants ---
        public const int OpticomGreenDurationMs = 5000; // How long light is forced
        ...
        public const float DetectionRange = 52f;
        public const float DetectionStartWidth = 7f;
        public const float DetectionEndWidth = 6f;

        public const float DetectionHeightOffset = -0.5f; // How high above the player's position to center the detection box.

        public const float DetectionAreaHeight = 7.0f; // The total vertical size (thickness) of the detection box.
